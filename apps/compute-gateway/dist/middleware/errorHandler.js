...
exports.errorHandler = exports.Errors = exports.AppError = void 0;
...
exports.Errors = {
    ...
    // 业务错误
    INSUFFICIENT_BALANCE: (message = 'AGC积分余额不足') => new AppError(message, 402, 'INSUFFICIENT_BALANCE'),
    RATE_LIMIT_EXCEEDED: (message = '请求频率超限') => new AppError(message, 429, 'RATE_LIMIT_EXCEEDED'),
    MODEL_NOT_AVAILABLE: (message = '模型暂不可用') => new AppError(message, 503, 'MODEL_NOT_AVAILABLE'),
    PROVIDER_ERROR: (message = '供应商服务异常') => new AppError(message, 502, 'PROVIDER_ERROR'),
    // 系统错误
